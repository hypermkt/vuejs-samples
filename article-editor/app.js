...
exports.default = {
  ...
  methods: {
    ...
    // アイテムを追加
    addItem: function addItem(form_kind) {
      var item = {};
      item.type = form_kind;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d2ae6900", module.exports)
  } else {
